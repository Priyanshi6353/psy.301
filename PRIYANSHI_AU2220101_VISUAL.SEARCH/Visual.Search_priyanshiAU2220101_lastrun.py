...
expName = 'Visual.Search_priyanshiAU2220101'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\PRIYANSHI\\OneDrive\\Documents\\PRIYANSHI_AU2220101_VISUAL.SEARCH\\Visual.Search_priyanshiAU2220101_lastrun.py',
